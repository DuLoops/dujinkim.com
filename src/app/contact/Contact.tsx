...
export default function Contact() {
  return (
    ...
    <div className='w-11/12 m-auto flex flex-col gap-10 items-center lg:grid grid-cols-[39%,61%] grid-rows-auto mb-[100px]'>
      <p className='hidden lg:block text-center text-xl'>Connect with <span className='text-orange-400'>Dujin</span> Kim!</p>
      <Social />
      ...
      <div className='w-3/5 m-auto col-start-1 '>
        <Image src={'/images/dev/dujinlogo.svg'} width={200} height={200} alt='Dujin Logo' />
      </div>
    </div>
    </div>
  )
